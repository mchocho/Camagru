...
<html>
	...
	<body>
			...
			<div class="settings_container">
				...
				<div class="edit notifications">
					...
					<form action="includes/handle_settings.php" method="POST" id="notifications_input" class="input hide">
						<?php
							$val = '';
							echo '<button type="button" id="icon_slider" class="slider';
							if ($result['notifications'] === 'F') {
								echo ' off';
							}
							echo '"';
							if ($result['notifications'] === 'T')
								echo '><label for="slider_input">Disable';
							else
								echo '><label for="slider_input">Enable';
							echo '<input type="checkbox" id="slider_input" class="notifications" name="notifications" value="on"';
							if ($result['notifications'] === 'T') {
								echo ' checked="check"';
							}
							echo ' ></label></button>';
		...
		<script>
			...
			document.getElementById('icon_slider').addEventListener('click', function() {
